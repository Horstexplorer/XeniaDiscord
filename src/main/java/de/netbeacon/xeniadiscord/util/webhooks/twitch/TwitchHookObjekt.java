...
public class TwitchHookObjekt {
    ...
    String toJSONString(){
        return "{\"twitchchannelname\":\""+this.channelname+"\",\"twitchchannelid\":\""+this.channelid+"\",\"guildchannelid\":\""+this.guildchannelid+"\",\"customnotification\":\""+this.customnotification.replace("\n", "\\n")+"\",\"notifyeveryone\":"+this.notifyeveryone+"}";
    }
}
